...
export class DashboardComponent implements OnInit {
    ...
    constructor() {
        ...
        this.options = {
            title: { text: 'Multas Asociadas en los ultimos 12 Meses' },
            series: [{
                name: 'Número de multas ',
                data: [1230, 1500, 2100, 2000, 1300, 3000, 1600, 1340, 1650, 1600, 1400, 1900]
            }],
            xAxis: {
        ...
        this.options7 = {
            ...
            title: {
                text: 'Multas por Categoria - 12 Meses'
            },
            xAxis: {
                type: 'category',
                labels: {
